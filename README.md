# AQCat(Air Quality Cat)
<img src="img/catFinishedProject.jpg" width="300">

AQCat (Air Quality Cat) is a cat-shaped air quality monitoring system that measures environmental conditions in real time. It collects sensor data such as temperature, humidity, and CO2, providing users with a simple and engaging way to monitor their surroundings. 
...
<img src="img/memeAir.png" width="385"> <img src="img/i-need-air-squirrel.jpg" width="300">
